    ...
    <>
      <nav className="relative px-4 py-4 flex justify-between items-center">
        ...
        <ul className=" hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2  lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          ...
          <li>
            <Link className="text-sm text-white font-bold" to="/about">
              About Us
            </Link>
          </li>
          <li className="text-gray-300">
          ...
          <li>
            <Link className="text-sm text-white font-bold" to="/pricing">
              Pricing
            </Link>
          </li>
          ...
          <li>
            <Link className="text-sm text-white font-bold" to="/team">
              Team
            </Link>
          </li>
          <li className="text-gray-300">
          ...
          <li>
            <Link className="text-sm text-white font-bold" to="/contact">
              Contact
            </Link>
          </li>
        </ul>
